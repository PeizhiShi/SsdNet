...
def encode(matched, priors, variances):
    ...
    g_depth = matched[:,4:5]/priors[:, 4:5]
    g_depth = torch.log(g_depth)/variances[1]
    return torch.cat([g_cxcy, g_wh, g_depth], 1)  # [num_priors,4]
...
#def nms2(boxes, scores, overlap=0.5, top_k=200):
